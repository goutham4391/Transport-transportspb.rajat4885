...
var DEFAULT_OPTIONS = {
    ...
    skipInputPaddingLeft: false,
    skipInputPaddingRight: false
};
...
Suggestions.prototype = {
    ...
    fixPosition: function (e) {
        ...
        if (elLayout.componentsLeft > elLayout.paddingLeft && that.options.skipInputPaddingLeft == false) {
            that.el.css('paddingLeft', elLayout.componentsLeft + 'px');
        }
        if (elLayout.componentsRight > elLayout.paddingRight && that.options.skipInputPaddingRight == false) {
